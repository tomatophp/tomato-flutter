...
class TomatoFlutterGenerateController extends Command
{
    use RunCommand;
    use HandleStub;
     ...
     * @var string
     */
    protected $name = 'tomato-flutter:controller';
     ...
     * @var string
     */
    protected $description = 'generate new controller into flutter app';
    ...
    public function handle()
    {
        ...
        $controller = text(
            label: 'What is your controller name?',
            placeholder: 'Home',
            required: true
        );
